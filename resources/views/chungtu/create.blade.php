...
<div class="container">
    ...
    <form action="{{ route('chungtu.store') }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" name="duong_dan" id="duong_dan" class="form-control" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <select name="nguoi_tao_id" id="nguoi_tao_id" class="form-control">
                <!-- Nếu cần, bạn có thể thêm dữ liệu người tạo -->
